...
CREATE TABLE IF NOT EXISTS public.performers (
    ...
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    CONSTRAINT performers_kind_name_key UNIQUE (kind),
    CONSTRAINT performers_kind_name_key UNIQUE (name),
...
CREATE TABLE IF NOT EXISTS public.project_memberships (
    ...
    user_id uuid NOT NULL,
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    CONSTRAINT project_memberships_pkey PRIMARY KEY (project_id),
    CONSTRAINT project_memberships_pkey PRIMARY KEY (user_id),
    CONSTRAINT project_memberships_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id),
    CONSTRAINT project_memberships_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE IF NOT EXISTS public.report_plan_marks (
    ...
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    CONSTRAINT report_plan_marks_pkey PRIMARY KEY (id),
    CONSTRAINT report_plan_marks_plan_id_fkey FOREIGN KEY (plan_id) REFERENCES public.plans(id),
    CONSTRAINT report_plan_marks_report_id_fkey FOREIGN KEY (report_id) REFERENCES public.reports(id)
);
...
CREATE TABLE IF NOT EXISTS public.work_types (
    ...
    created_by uuid,
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    CONSTRAINT work_types_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.profiles(id),
...
-- Function: public.admin_list_profiles
CREATE OR REPLACE FUNCTION public.admin_list_profiles()
 RETURNS TABLE(id uuid, full_name text, email text, role user_role, is_active boolean, created_at timestamp with time zone, updated_at timestamp with time zone)
 LANGUAGE sql
...
-- Function: public.citext_hash_extended
...
-- Function: public.citext_pattern_cmp
...
-- Function: public.citext_smaller
...
-- Function: public.get_author_name
...
-- Function: public.get_author_names
...
-- Function: public.is_active_user
...
-- Function: public.regexp_split_to_array
...
-- Function: public.regexp_split_to_table
...
-- Function: storage.allow_any_operation
...
-- Function: storage.allow_only_operation
...
-- Trigger: set_plans_updated_at on public.plans
CREATE TRIGGER set_plans_updated_at BEFORE UPDATE ON public.plans FOR EACH ROW EXECUTE FUNCTION set_updated_at()

-- Trigger: set_updated_at on public.profiles
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.profiles FOR EACH ROW EXECUTE FUNCTION set_updated_at()

-- Trigger: set_updated_at on public.projects
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.projects FOR EACH ROW EXECUTE FUNCTION set_updated_at()

-- Trigger: set_updated_at on public.reports
CREATE TRIGGER set_updated_at BEFORE UPDATE ON public.reports FOR EACH ROW EXECUTE FUNCTION set_updated_at()
