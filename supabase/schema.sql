...
-- =====================================================================
-- 10. Supabase Realtime: публикация таблиц для межпользовательских
--     уведомлений. RLS фильтрует события автоматически — пользователи
--     получат только те строки, к которым имеют SELECT-доступ.
-- =====================================================================
...
-- =====================================================================
-- 11. get_author_names: батчевая версия get_author_name.
--     Принимает массив UUID'ов, возвращает (author_id, full_name).
--     Убирает N+1 RPC-вызовов при загрузке списка отчётов.
-- =====================================================================
