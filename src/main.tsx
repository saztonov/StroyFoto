...
import { setUpdateSW } from '@/services/appUpdate'
...
// вкладки и при выходе в онлайн. При обнаружении новой версии — применяем
// автоматически (updateSW(true) делает skipWaiting + reload), без баннера
// и ручных действий пользователя.
