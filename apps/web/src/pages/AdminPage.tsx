    ...
    <div className="px-4 py-4">
      ...
      {activeTab === "overview" && (
        <>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        title="Удалить отчёты проекта"
                        className="rounded-lg p-1.5 text-gray-400 hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-900/30 dark:hover:text-red-400 transition"
                      >
          ...
          {stats && stats.totalReports > 0 && (
            <div className="mt-8 rounded-xl border border-red-200 dark:border-red-900/50 p-4">
              <h3 className="mb-3 text-sm font-semibold text-red-600 dark:text-red-400">Опасная зона</h3>
              <button
              ...
              <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                Удаляет все отчёты и фотографии из базы данных и хранилища. Действие необратимо.
              </p>
            </div>
          )}
        </>
      ...
      {bulkDeleteTarget && (
        <BulkDeleteConfirmModal
          ...
          projectId={bulkDeleteTarget.projectId}
